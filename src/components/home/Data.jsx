...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Abhishek Dixit
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            I am a full stack developer with a passion for learning and building software. I love to work on projects that are challenging and challenging. I love to learn new things and have fun.
            </p>
